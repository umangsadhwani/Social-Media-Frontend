        ...
        <div>
          ...
          <div className="postOptions">
            ...
            <div  style={{display:"none"}}>
              <input type="file" name="myImage" accept="image/png, image/gif, image/jpeg" ref={imageRef}  onChange={onImageChange} onClick={(event)=> { 
               event.target.value = null
          }} />
            </div>
            <div style={{display:"none"}}>
              <input type="file" name="myImage" ref={videoRef} accept="video/mp4,video/x-m4v,video/*"  onChange={onVideoChange} onClick={(event)=> { 
               event.target.value = null
          }} />
            </div>
          </div>
